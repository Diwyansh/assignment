...
import 'package:assignment/screens/item_list/views/item_list.dart';
    ...
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (setting) {
         if(setting.name == CheckoutScreen.routeName) {
           return MaterialPageRoute(builder: (context) => CheckoutScreen(itemsList: setting.arguments as List<ItemModel>,));
         }
        },
      ),
    );
